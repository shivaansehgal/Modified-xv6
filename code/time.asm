...
int main (int argc,char *argv[])
{
  ...
  12:	8b 59 04             	mov    0x4(%ecx),%ebx
    ...
    int  a, b;   
    pid = fork();
  15:	e8 90 02 00 00       	call   2aa <fork>
    if (pid == 0)
  ...
  24:	e8 c1 02 00 00       	call   2ea <exec>
        printf(1, "exec %s failed\n", argv[1]);
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	ff 73 04             	pushl  0x4(%ebx)
  2f:	68 40 07 00 00       	push   $0x740
  34:	6a 01                	push   $0x1
  36:	e8 e5 03 00 00       	call   420 <printf>
  ...
  41:	ff 75 f0             	pushl  -0x10(%ebp)
  44:	68 50 07 00 00       	push   $0x750
  49:	6a 01                	push   $0x1
  4b:	e8 d0 03 00 00       	call   420 <printf>
    exit();
  50:	e8 5d 02 00 00       	call   2b2 <exit>
        exec(argv[1], argv);
        printf(1, "exec %s failed\n", argv[1]);
    }
    else
  ...
  5a:	50                   	push   %eax
  5b:	8d 45 f0             	lea    -0x10(%ebp),%eax
  5e:	50                   	push   %eax
  5f:	e8 ee 02 00 00       	call   352 <waitx>
  64:	83 c4 10             	add    $0x10,%esp
  67:	eb d5                	jmp    3e <main+0x3e>
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 70 07 00 00       	mov    $0x770,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 14 0a 00 00       	mov    0xa14,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 14 0a 00 00       	mov    %eax,0xa14
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 14 0a 00 00    	mov    0xa14,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 14 0a 00 00    	mov    %edx,0xa14
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 71d:	0a 00 00 
 720:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 18 0a 00 00       	mov    $0xa18,%eax
 72f:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 736:	00 00 00 
