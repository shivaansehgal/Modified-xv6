...
main(int argc, char *argv[])
{
  ...
  4c:	51                   	push   %ecx
  4d:	51                   	push   %ecx
  4e:	68 5a 07 00 00       	push   $0x75a
  53:	6a 02                	push   $0x2
  55:	e8 c6 03 00 00       	call   420 <printf>
      exit();
  5a:	e8 53 02 00 00       	call   2b2 <exit>
  }
  chpr ( pid, priority );
  5f:	52                   	push   %edx
  60:	52                   	push   %edx
  61:	50                   	push   %eax
  62:	56                   	push   %esi
  63:	e8 fa 02 00 00       	call   362 <chpr>
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 75 07 00 00       	mov    $0x775,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 1c 0a 00 00       	mov    0xa1c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 1c 0a 00 00    	cmp    %eax,0xa1c
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 71d:	0a 00 00 
 720:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 20 0a 00 00       	mov    $0xa20,%eax
 72f:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 736:	00 00 00 
