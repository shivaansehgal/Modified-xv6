...
main(void)
{
  ...
  53:	68 e3 07 00 00       	push   $0x7e3
  58:	6a 01                	push   $0x1
  5a:	e8 41 04 00 00       	call   4a0 <printf>
    pid = fork();
  5f:	e8 c6 02 00 00       	call   32a <fork>
    if(pid < 0){
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 d0 0a 00 00       	push   $0xad0
  ab:	68 09 08 00 00       	push   $0x809
  b0:	e8 b5 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 0c 08 00 00       	push   $0x80c
  bc:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 2b 08 00 00       	mov    $0x82b,%eax
...
free(void *ap)
{
 ...
 641:	a1 d8 0a 00 00       	mov    0xad8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 d8 0a 00 00       	mov    %eax,0xad8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 d8 0a 00 00    	mov    %edx,0xad8
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 79d:	0a 00 00 
 7a0:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 dc 0a 00 00       	mov    $0xadc,%eax
